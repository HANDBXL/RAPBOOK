 ...
 * Chaque clé correspond à l'index de l'image cible (targetIndex) dans le fichier .mind
 */
...
const RAP_CONFIG = {
    0: {
        ...
        artist: "IAM",
        youtubeId: "7ceNf9qJjgc", // Exemple: Chanson rap classique
...
Hey DJ, mets nous donc du Funk, que je danse le MIA
Je danse le MIA`,
        gif: "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNHJmZzR6NHJmZzR6NHJmZzR6NHJmZzR6NHJmZzR6NHJmZzR6JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1n/l41lTfuxsQuZcE7S0/giphy.gif",
        isDoublePage: true, // Illustration sur une seule page, l'autre est blanche
        contentOffset: { x: -1, y: 0, z: 0 } // Décalage vers la gauche (page blanche) pour les paroles
    },
    1: {
        title: "L'Âge d'Or",
        artist: "90's Legend",
        ...
        gif: "https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNHJmZzR6NHJmZzR6NHJmZzR6NHJmZzR6NHJmZzR6NHJmZzR6JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1n/3o7TKVUn7iM8FMEU24/giphy.gif",
        isDoublePage: false, // Deux illustrations, on reste centré
        contentOffset: { x: 0, y: 0, z: 0 }
    }
};

export default RAP_CONFIG;
